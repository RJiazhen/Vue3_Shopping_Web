<template>
  <div class="clearfix selector">
      ...
      <div class="value logos">
        <ul class="logo-list">
          <li v-for="(trademark, index) in trademarkList" :key="trademark.tmId"
            @click="$emit('trademarkHandler', trademark)">{{ trademark.tmName }}</li>
        </ul>
      </div>
      <div class="ext">
    ...
    <div class="type-wrap" v-for="(attr, index) in attrsList" :key="attr.attrId">
      ...
      <div class="fl value">
        <ul class="type-list">
          <li v-for="(attrValue, index) in attr.attrValueList" :key="index" @click="$emit('selectAttr', attr.attrId, attr.attrName, attrValue)">
            <a>{{ attrValue }}</a>
          </li>
        </ul>
      </div>
